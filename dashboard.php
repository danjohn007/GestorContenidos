    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="p-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <a href="<?php echo url('multimedia.php'); ?>" class="flex flex-col items-center justify-center p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-orange-500 hover:bg-orange-50 transition-colors">
                    <i class="fas fa-images text-3xl text-orange-500 mb-2"></i>
                    <span class="text-sm font-medium text-gray-700">Multimedia</span>
                </a>
            </div>
        </div>
    </div>
